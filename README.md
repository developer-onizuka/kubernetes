...
```
                                    ...
                                    +----master-----+           +----maste--------+
                    192.168.122.183 |               |           |                 | 
iPhone,etc                  +------>| Nginx Service +-----+     |                 |
|                           |       |               |     |     |                 |
|    +---------+            |       +---------------+     |     +-----------------+
|    |         +------------+       +----worker2----+     |     +----worker1------+
|    |         |    192.168.122.18  |               |     |---->| Nginx Pod       | 192.168.189.91:80
+--->+ HAProxy +------------------->| Nginx Service +-----+     | Employee Pod x2 |
     |         |                    |               |     |     |                 |
     |         +------------+       +---------------+     |     +-----------------+
     +---------+            |       +----worker2----+     |     +----worker2------+
     192.168.11.27          |       |               |     |---->| Nginx Pod       | 192.168.235.150:80
                            +------>| Nginx Service +-----+     | Employee Pod x2 |
                    192.168.122.219 |               |           | mongoDB Pod     |
                                    +---------------+           +-----------------+
```
