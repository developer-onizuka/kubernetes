...
| --- | --- | --- | --- | --- |
| Internal IP | Each Master/Worker | 192.168.122.183, etc | between Host Machine and Master/workers | kubelet manages InternalIP as node-ip in /etc/default/kubelet |
